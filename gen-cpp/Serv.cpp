...
Serv_add_args::~Serv_add_args() throw() {
}
...
Serv_add_pargs::~Serv_add_pargs() throw() {
}
...
Serv_add_result::~Serv_add_result() throw() {
}
...
Serv_add_presult::~Serv_add_presult() throw() {
}
...
void ServClient::add(const Student& s)
{
  send_add(s);
  recv_add();
}

void ServClient::send_add(const Student& s)
{
  int32_t cseqid = 0;
...
void ServClient::get(Student& _return)
{
  send_get();
  recv_get(_return);
}
